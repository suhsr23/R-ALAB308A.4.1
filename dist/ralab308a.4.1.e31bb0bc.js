...
function loadBreeds() {
  return _loadBreeds.apply(this, arguments);
} // Function to get images for a specific breed
function _loadBreeds() {
  _loadBreeds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, breedSelect;
...
function _getImages() {
  _getImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(breedId) {
    var response;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          response.data.forEach(function (image) {
            var carouselItem = (0, _Carousel.createCarouselItem)(image.url, image.id, image.id);
        ...
        case 10:
          ...
          console.error("Error getting images:", _context2.t0);
        case 13:
        case "end":
...
function _favourite() {
  _favourite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(imageId) {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          response.data.forEach(function (fav) {
            var carouselItem = (0, _Carousel.createCarouselItem)(fav.image.url, fav.id, fav.id);
            (0, _Carousel.appendCarousel)(carouselItem);
          });
          (0, _Carousel.start)();
          _context4.next = 13;
        ...
        case 10:
          ...
          console.error("Error getting favorites:", _context4.t0);
        case 13:
        case "end":
...
document.getElementById("breedSelect").addEventListener("change", function (event) {
  getImages(event.target.value);
});
document.getElementById("getFavouritesBtn").addEventListener("click", function () {
  getFavorites();
});

// Initial load
loadBreeds();
},{"./Carousel":"Carousel.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/ralab308a.4.1.e31bb0bc.js.map